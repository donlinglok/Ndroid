...
public class NString {
	...
	public static final String parse(final Object obj) {
		return null == obj ? "" : obj.toString();
	}

	public static final String parse(final Object obj, final String defaultvalue) {
		return It.isNull(obj) ? defaultvalue : obj.toString();
	}

	public static final String parse(final boolean booleans) {
		return booleans ? "true" : "false";
	}

	public static final String parse(final int ints) {
		return Integer.toString(ints, 10);
	}

	public static final String parse(final long longs) {
		return Long.toString(longs, 10);
	}

	public static final String parse(final float floats) {
